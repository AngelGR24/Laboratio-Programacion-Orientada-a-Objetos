...
public class Druida extends Personajes implements Hechicero, Sanador {
    ...
    public void atacar() throws RpgException {
        if (!isEstaVivo()) {
            ...
            mana -= 10;
            System.out.println(getNombre() + " ataca con las fuerzas de la naturaleza en su forma de " + formaAnimal + ". Mana restante: " + mana);
        }
    }  
    ...
    @Override
    public void curarAliado(Personajes aliado) throws RpgException{
        if(aliado==null){
            throw new PersonajeNuloException("curarAliado");
        }
        else if (!aliado.estaVivo){
